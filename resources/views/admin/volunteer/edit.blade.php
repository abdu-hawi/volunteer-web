                        ...
                        <div class="card-body register-card-body col-md-6" style="margin-left: auto;margin-right: auto;">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" id="mobile" class="form-control  @error('mobile') is-invalid @enderror"
                                       name="mobile" value="0{!! $volunteer->mobile !!}"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select id="gender" name="gender" class="form-control  @error('gender') is-invalid @enderror">
                                    ...
                                    <option value="male" @if($volunteer->gender == "male") selected @endif>ذكر</option>
                                    <option value="female" @if($volunteer->gender == "female") selected @endif>أنثى</option>
                                </select>
                                @error('gender')
                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="national_id" class="form-control  @error('national_id') is-invalid @enderror"
                                       name="national_id" value="{!! $volunteer->national_id !!}"
                            ...
                            <div class="input-group mb-3">
{{--                                {!! dd($volunteer->programs[0]->pivot->program_id) !!}--}}
