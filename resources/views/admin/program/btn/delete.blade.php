    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header bg-danger">
                <h4 class="modal-title">حذف المجموعة التطوعية</h4>
...
{{--                <h5>{!! trans('admin.Are you sure you want delete city',['s'=>'( ','name'=>lang() == 'ar'?$city_name_ar:$city_name_en,'q'=>' )?']) !!}</h5>--}}
                <h5>هل أنت متأكد برغبتك في حذف المجموعة ({!! $name !!})؟</h5>
            </div>

            <!-- Modal footer -->
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-dark" data-dismiss="modal">اغلاق</button>
                <button type="submit" class="btn btn-outline-danger delete-city-{!! $id !!}" data-dismiss="modal">موافق</button>
            </div>
